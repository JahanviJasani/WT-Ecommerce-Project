...
<html>
<head>
<title>Elite Shoppy an Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template |Men's</title>
<!--/tags -->
			...
			<div class="css-treeview">
				...
				<ul class="tree-list-pad">
					<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Categories</label>
						<ul>
								<ul class="sublist">
									<li><a id="113" href="#" onclick="addURL('Watch','Men',id)">Men's</a></li>
									<li><a id="114" href="#" onclick="addURL('Watch','Women',id)">Women's</a></li>
								</ul>
						</ul>
					</li><br>
					<li><input type="checkbox" id="item-1" checked="checked" /><label for="item-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> New Arrivals</label>
						<ul>
							<ul class="sublist">
								<li><a id="115" href="#" onclick="addURL('Watch','Men',id)">Men's</a></li>
								<li><a id="116" href="#" onclick="addURL('Watch','Women',id)">Women's</a></li>
							</ul>
						</ul>
					</li>
				</ul>
			...
			<div class="men-wear-top">
				<div class="clearfix"></div>
					...
					if (isset($_GET['displaytype'])) {
						...
						$sql1 = "SELECT * FROM product,watches WHERE product.product_id=watches.product_id AND product.category='$category' AND watches.display_type='$display_type' AND product.gender='men'";
					} else {
						$sql1 = "SELECT * FROM product,watches WHERE product.product_id=watches.product_id AND product.category='$category' AND product.gender='men'";
					}

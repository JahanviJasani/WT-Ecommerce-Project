...
?>
	...
	<div class="container-fluid">
			...
			<div class="css-treeview">
				...
				<ul class="tree-list-pad">
					<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Categories</label>
						<ul>
								<ul class="sublist">
									<li><a id="41" href="#" onclick="addURL('Footwear','Casual',id)"><i class="fa fa-caret-right" aria-hidden="true"></i> Casual Shoes</a></li>
									<li><a id="42" href="#" onclick="addURL('Footwear','Canvas',id)"><i class="fa fa-caret-right" aria-hidden="true"></i> Canvas Shoes</a></li>
									<li><a id="43" href="#" onclick="addURL('Footwear','Loafers',id)"><i class="fa fa-caret-right" aria-hidden="true"></i> Loafers</a></li>
					...
					<li><input type="checkbox" id="item-1" checked="checked" /><label for="item-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> New Arrivals</label>
						<ul>
							<ul class="sublist">
								<li><a id="81" href="#" onclick="addURL('Footwear','Casual',id)"><i class="fa fa-caret-right" aria-hidden="true"></i> Casual Shoes</a></li>
								<li><a id="82" href="#" onclick="addURL('Footwear','Canvas',id)"><i class="fa fa-caret-right" aria-hidden="true"></i> Canvas Shoes</a></li>
								<li><a id="83" href="#" onclick="addURL('Footwear','Loafers',id)"><i class="fa fa-caret-right" aria-hidden="true"></i> Loafers</a></li>
					...
					<li><input type="checkbox" id="item-3" style="position: absolute; opacity: 0;" checked="checked" /><label for="item-3"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Prices</label>
						<ul>
							<ul class="sublist">
								...
								<span class="a-color-base s-ref-small-padding-left s-ref-price-currency s-small-margin-left">₹</span>
								<input type="text" maxlength="9" id="high-price" placeholder="Max" name="high-price" class="a-input-text a-spacing-top-mini s-ref-price-range s-ref-price-padding s-small-margin-left" aria-label="Max">
		...
		<div class="col-md-9 products-right">
			<h5>Men's <span>Footwear</span></h5>
			<div class="sort-grid">
				<div class="sorting">
					<h6>Sort By</h6>
				...
				<div class="clearfix"></div>
					...
					if (isset($_GET['disc_range'])) {
						if (isset($_GET['size'])) {
							...
							if($type=="All") {
								$sql1="SELECT DISTINCT * FROM product,footwear WHERE product.product_id=footwear.product_id AND product.category='$category' AND product.discount >= '$disc_range' AND product.gender='men'"." ".$sortby;
							}
							else {
								$sql1="SELECT DISTINCT * FROM product,footwear WHERE product.product_id=footwear.product_id AND product.category='$category' AND product.discount >= '$disc_range' AND footwear.subcategory='$type' AND product.gender='men'"." ".$sortby;
							}
						}
					} else {
						if (isset($_GET['size'])) {

					...
					<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Categories</label>
						<ul>
								<ul class="sublist">
									...
									<li><a id="55" href="#" onclick="addURL('Footwear','FlipFlops',id)"><i class="fa fa-caret-right" aria-hidden="true"></i> Flip Flops</a></li>
			...
			<div class="men-wear-top">
				<div class="clearfix"></div>
					...
					if (isset($_GET['size'])) {
						...
						$sql1="SELECT DISTINCT * FROM product,footwear WHERE product.product_id=footwear.product_id AND product.category='$category' AND footwear.subcategory='$type' AND product.gender='women'";
					}
					$minprice=0;
					$maxprice=9999999;
					if (isset($_GET['range'])) {
